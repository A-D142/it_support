              ...
              @csrf
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="title" class="form-control" name="email">
                  </div>
                  <div class="form-group">
                    <label for="exampleFomControlInput1">password</label>
                    <input type="title" class="form-control" placeholder="password" name="password">
                  </div>

                  <div class="form-group">
                    <label for="exampleFomControlInput1">department</label>
                    <input type="title" class="form-control" placeholder="department" name="department">
                  </div>
